...
class IntialInterface:
    ...
    def Window(self):
        ...
        self.label.configure(background="#E676F7")
        self.label.place(x=150, y=100)

        self.button_enter = tk.Button(self.window, text="Entrar", relief='flat')
        self.button_enter.configure(background="#DA30F5", width=15, height=5)
        ...
        self.button_register.configure(background="#DA30F5", width=15, height=5)
